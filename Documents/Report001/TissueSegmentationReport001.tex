...
\center
\begin{tabular}{c}
\includegraphics[width=0.8\textwidth]{../../Testing/Temporary/ernou_tor5564m12_small.png}
\end{tabular}
...
\center
\begin{tabular}{c}
\includegraphics[width=0.8\textwidth]{../../Testing/Temporary/ernou_tor5564m12.png}
\end{tabular}
\itkcaption[Original Image]{Cropped section of original image}
\label{fig:OriginalImage}
\end{figure}
...
\center
\begin{tabular}{c}
\includegraphics[width=0.8\textwidth]{../../Testing/Temporary/ernou_tor5564m12_classified_colors.png}
\end{tabular}
\itkcaption[Classified Image]{Classified image}
\label{fig:OriginalImage}
\end{figure}
